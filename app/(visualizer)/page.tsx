      ...
      <div className="grid gap-4 sm:grid-cols-2 w-full max-w-lg">
        {categories.map((cat) => {
          ...
          return (
            ...
            >
              <div className="flex size-10 items-center justify-center border border-border bg-background text-algo-green transition-colors group-hover:bg-[#017501] group-hover:text-white">
